    ...
    <div className="lg:flex text-textPrimary text-center py-6">
      <div className="lg:flex-1 mx-10">
        ...
        <div className="grid grid-cols-3 mt-4 px-14">
          <Link href="https://www.instagram.com/alexadevsrm/">
            <Instagram className="lg:mx-10 mx-4" />
          </Link>
          <Link href="https://www.linkedin.com/company/alexa-developers-srm/">
            <LinkedIn className="lg:mx-10 mx-4" />
          </Link>
          <Link href="mailto:hello@alexadevsrm.com">
      ...
      <div className="lg:flex-1 lg:mt-0 mt-5 mx-10">
        ...
        <div className="grid grid-cols-2 mt-4 px-24">
          <Link href="https://www.instagram.com/schoolofcomputingsrmist/">
            <Instagram className="lg:mx-10 mx-4" />
          </Link>
          <Link href="https://www.linkedin.com/company/school-of-computing-srmist/">
            <LinkedIn className="lg:mx-10 mx-4" />
          </Link>
        </div>
      </div>
      <div className="lg:flex-1 lg:mt-0 mt-5 mx-10">
        ...
        <div className="grid grid-cols-3 mt-4 px-14">
          <Link href="https://www.instagram.com/githubsrm/">
            <Instagram className="lg:mx-10 mx-4" />
          </Link>
          <Link href="https://www.linkedin.com/company/githubsrm/mycompany/">
            <LinkedIn className="lg:mx-10 mx-4" />
          </Link>
          <Link href="/">
            <Mail className="lg:mx-10 mx-4" />
